    ...
    <footer className="bg-neutral-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 font-sans">Product</h3>
          ...
          {/* Support */}
          <div>
            <h3 className="text-lg font-semibold mb-4 font-sans">Terms & Support</h3>
            <ul className="space-y-2">
              <li>
          ...
          <div>
            <h3 className='text-lg font-semibold mb-4 font-sans'> Download Application</h3>
