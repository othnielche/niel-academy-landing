        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col space-y-3">
              <a 
                ...
                className="flex items-center space-x-3 text-neutral-300 hover:text-brand-primary transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/privacy-policy" className="text-neutral-300 hover:text-brand-primary transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
