User: Brian Wirngo
Review: very very good but Not all subject like Religious studies is not there both for O-level and A-level
Stars: 4

User: Mesue Mark
Review: i love 😘 the app just that is limited to 2020 pass questions
Stars: 5

User: NANGWE DAVID
Review: THE BEST SO FAR IN CAMEROON🇨🇲
Stars: 5
...
```bash
lucide-react, @radix-ui/react-avatar, embla-carousel-react, @radix-ui/react-slot, class-variance-authority
```
